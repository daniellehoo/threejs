...
import { EffectComposer, EffectPass, SSAOEffect, RenderPass} from "postprocessing";
class Threejs extends Component {
  ...
  let ssaoPass = new EffectPass(this.camera, new SSAOEffect(this.camera));
  ssaoPass.renderToScreen = true;
  ssaoPass.kernelRadius = 16;
  let effectComposer = new EffectComposer( this.renderer );
